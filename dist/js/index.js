...
jquery_bridget__WEBPACK_IMPORTED_MODULE_6___default()('masonry', masonry_layout__WEBPACK_IMPORTED_MODULE_5___default.a, jquery__WEBPACK_IMPORTED_MODULE_4___default.a); // $(document).ready(() => {
//   $('.grid').masonry({
...
var $masn = jquery__WEBPACK_IMPORTED_MODULE_4___default()('.pictures-package').masonry({
  itemSelector: '.item',
  columnWidth: '.grid-sizer'
}); // search-form

function animated() {
  if (document.getElementById('search').style.opacity) then(document.getElementByClassName('button').style.opacity = 1);
}
...
;
jquery__WEBPACK_IMPORTED_MODULE_4___default()('.pictures-package').masonry({
  itemSelector: '.item',
  columnWidth: '.grid-sizer',
  percentPosition: true
}); // load all pictures

var URL = 'https://my-json-server.typicode.com/ha100790tag/baseBuildJS/images';
!function getResponse(targetUrl) {
  jquery__WEBPACK_IMPORTED_MODULE_4___default.a.ajax({
    ...
    success: function success(respText) {
      ...
      respText.forEach(function (el, i) {
        var pic = jquery__WEBPACK_IMPORTED_MODULE_4___default()('<img></img>');
        var dv = jquery__WEBPACK_IMPORTED_MODULE_4___default()('<div></div>');
        dv.addClass('item');
        ...
        dv.append(pic); // $(allpic).append(dv);

        $masn.append(dv).masonry('appended', dv) // layout
        .masonry();
      });
    }
  });
...
jquery__WEBPACK_IMPORTED_MODULE_4___default()('.pic-menu-links').on('click', function (e) {
  jquery__WEBPACK_IMPORTED_MODULE_4___default()('.pic-item a').removeClass('all-active');
  jquery__WEBPACK_IMPORTED_MODULE_4___default()(e.target).addClass('all-active');
  var txt = jquery__WEBPACK_IMPORTED_MODULE_4___default()(e.target).text().toLowerCase();
  filerImg('allpic', txt);
});

function filerImg(imgContId, className) {
  Array.from(jquery__WEBPACK_IMPORTED_MODULE_4___default()('#' + imgContId + ' img')).forEach(function (el) {
    jquery__WEBPACK_IMPORTED_MODULE_4___default()(el).show();
    var element = jquery__WEBPACK_IMPORTED_MODULE_4___default()(el);
